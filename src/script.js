...
const geo2 = new THREE.BoxGeometry(.5,.5,.5,6)
// Materials
...
material.color = new THREE.Color(0xff292929)
...
pointLight2.position.set(-2.53,1.61,-1.52)
...
pointLight3.position.set(3,-2.99,-1.52)
